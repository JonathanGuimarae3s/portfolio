  ...
  public arrayProjects = signal<Projects[]>([
    {
      ...
      A Ilha é uma empresa focada na produção de rabanadas de diversos tipos e sabores. Além disso, conta com serviços de delivery.Essa segunda versao do sistema web veio para corrigir algumas falhas e fizemos a troca da linguagem de back-end</p>",
      tecnologies:"<ul>\
      ...
      description: "<p>Colaborei no desenvolvimento de um sistema focado em otimizar o serviço de\
      encomendas da empresa 'Ilha das Rabanadas.\
      A Ilha é uma empresa focada na produção de rabanadas de diversos tipos e sabores. Além disso, conta com serviços de delivery.</p>",
      tecnologies:"<ul>\
